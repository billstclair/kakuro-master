...
port module Kakuro exposing (Direction(..), PageSpec, addBoardSizesToModel, advertisePageDiv, answerConfirmed, answerProcessors, appIapElements, appStoreBlurb, boardIndexQuery, br, charToDigit, clickTap, confirmAnswer, confirmDialog, convertLinks, convertLinksLoop, convertOneLink, convertTimeToUnlockDate, creditsPageDiv, decodePlatform, deviceReady, discardExploration, doAnswerConfirmed, doIapBuy, doMultiAnswerConfirmed, doPromptAnswerConfirmed, doSeed, errorMessageHtml, extraPuzzlesProductId, footerDiv, forbidBoard, getBoard, getBoardFromSpec, getBoardIndex, getIapState, getKindIndex, gotDeviceReady, gotoBoard, helpPageDiv, helpWindowSize, iapBuy, iapBuyResponse, iapGetProducts, iapPageDiv, iapProductIds, iapProductRow, iapProducts, iapProductsDict, iapPurchases, iapPurchasesLoop, iapRestorePurchases, iapStatePropertyName, indicesInsert, init, initialKind, initialModel, keepExploration, keyCodeToDigit, linkDict, listHead, listTail, logoLink, lookupLink, mailLink, main, mainPageDiv, makeClickSound, maybeFetchProducts, maybeMakeClickSound, maybeResetAllGameStates, mergePurchasesIntoProducts, moveSelection, movementKeyDirections, multiAnswerConfirmed, multiAnswerProcessors, multiConfirmAnswer, multiConfirmDialog, multiRestartQuery, newLocation, newLocationLoop, newModelIndices, pFormat, pageLink, pageLinksLoop, pageTitle, playButton, processBoardIndexQuery, processDigitKeys, processIapBuy, processIapPurchases, processKeyDown, processKeyPress, processKeyUp, processMovementKeys, processMultiRestartQuery, processNewBoardIndex, processResetAllQuery, processRestartQuery, processWindowSize, promptAnswer, promptAnswerConfirmed, promptDialog, promptProcessors, propertiesToIapState, ps, puzzleEnablerLink, radio, rawPuzzleEnablerLink, realBoardIndex, reallyResetAllQuery, receiveGame, receiveGameJson, receiveProducts, receiveSpecHash, renderHelp, renderStarMenu, requestGame, resetAllGameStates, resetGameState, restartDialog, restartQuery, restrictBoards, saveGame, seedCmd, setProperty, setStorage, setTitle, shiftKeyCode, showValue, space, specHash, specHashDict, specHashReceiver, sqrimg, startExploration, subscriptions, tacticsPageDiv, textPageDiv, textPageSpecs, timePlayTick, timeTick, toInt, toggleFlag, toggleHint, toggleHintInput, toggleKeyClick, toggleShowPossibilities, unlockDateReason, update, updateExploreState, updateHelpPage, updateIapState, updateMainPage, updateSelectedCell, updateSelection, updateUnlockDateHash, updateWithStorage, view, webIapElements, windowSizeCmd)
...
processMovementKeys keyCode model =
    let
        char =
            Char.toLower <| Char.fromCode keyCode
    in
